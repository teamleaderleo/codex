...
This index collects the code, prototype, test, and issue references behind the [standalone issue](issue.md), [implementation draft](pull-request.md), and [technical deep dive](deep-dive.md).
...
- [Contribution policy](https://github.com/openai/codex/blob/95637f7056835fea66bdd0044414af480fc0fd74/docs/contributing.md)

## Exploratory implementation

- [Implementation and tests branch](https://github.com/teamleaderleo/codex/tree/fix/code-mode-live-session-ids)
...
The tests live on the same exploratory branch as the implementation. The larger acceptance module demonstrates the edge cases; the narrow change itself doesn't depend on presenting every case as part of one review.
...
- [Prototype validation record](validation.md)
